...
def main():
    ...
    # print(paired_reads)
    n = len(paired_reads)
    num_genomes = 100 # 10 for sample 100 for 1c
    maxes_per_read = {}
    for i in range(num_genomes):

        sw_count = 0
        filename = "project1c_genome_" + str(i) + ".fasta"
        # filename = "/Users/gabriellaang/Desktop/CS CM122/Project1/project1c/project1c_genome_99.fasta"
